...
function boutonV() {
    ...
    <div class="row">
            ...
            <div class="col-12 text-center">
              <input class="btn btn-primary btn-rounded" type="submit" value ="Valider">
            </div>
...
//     function headF2_html() {
//         return `
//     body {
//         background-image: url("toto_dodo.jpg");
//         background-size: cover;
//     }
...
<body>
    ...
    <form method="GET">
        <div class="row">
            ...
            <div id="titre" class="col-6" text-center>
        ...
        <form action="http://localhost:3000/Formulaire_taches" method="POST">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" required id="tache" name="userTache" class="form-control">
            </div>
            </br>
            <div class="form-group col-md-6">
                <label for="description"> Description : </label>
                <input type="text" required id="description" name="userDescription" class="form-control">
            </div>
            </br>
            <div class="form-group col-md-6">
...
function accueil1_html() {
    ...
    //             width: 500px;
    //             height: 500px;
    //             background-image: url("totoro_question2.png");
    //             background-size: cover;
    //          }
    //         body{
...
//             <br/>
//                     <div class="col-6">
//                         <button id="bouton1" type="submit" formaction="http://localhost:3000/get-task"
//                             class="btn btn-primary btn-rounded">ToDoList</button>
//                     </div>
//                     `
//     }
//                     function accueil3_html() {   
//                         return `             
//                     <br/>
//                     <div class="col-6">
//                         <button id="bouton2" type="submit" formaction="http://localhost:3000/Formulaire_taches"
...
//     }
    ...
    //         <button id="bouton1"  type="submit" formaction="http://localhost:3000/get-task" method="GET"
    //             class="btn btn-primary btn-rounded">ToDoList</button>
    //     </div>
    //     <div class="col-6 text-center">
    //         <button id="bouton2" type="submit" formaction="http://localhost:3000/Formulaire_taches" method="GET"
    //             class="btn btn-primary btn-rounded">Nouvelle tâche</button>
    //     </div>
    // </div>
...
<body>
    ...
    module.exports = {
        ...
        bodyF_html: bodyF_html,
        ferm_form_html: ferm_form_html,

        accueil1_html: accueil1_html,
        // accueil2_html: accueil2_html,
        // accueil3_html: accueil3_html,

        FAuthentificationH: FAuthentificationH
        // FAuthentificationB: FAuthentificationB,
        // FAuthentificationS: FAuthentificationS
